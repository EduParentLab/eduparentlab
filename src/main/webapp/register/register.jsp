    ...
    <main>
      <div class="center-wrapper">
        <div class="resistcontainer">
        	<div>
        	<img src="../designer/assets/back.png" onclick="history.back()" style="width:20px;height:20px; cursor:pointer;" />
        	</div>
			...
			<div>
			  <select id="gender" name="gender" style="
			    ...
			    appearance: none;
			    background-image: url('data:image/svg+xml;charset=UTF-8,<svg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' xmlns=\'http://www.w3.org/2000/svg\'><path d=\'M7 10L12 15L17 10\' stroke=\'%23999\' stroke-width=\'2\' stroke-linecap=\'round\' stroke-linejoin=\'round\'/></svg>');
