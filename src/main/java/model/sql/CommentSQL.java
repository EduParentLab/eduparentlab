...
public class CommentSQL {
	public final static String LIST = "select comment_num, email, comment_content, comment_date from comments where post_num = ? and comment_num = group_num LIMIT ?, ?";
	public final static String LIST_L = "select comment_num, email, comment_content, comment_date from comments where post_num = ? and comment_num = group_num order by comment_num desc LIMIT ?,?";
	...
	public final static String LIST_R = "SELECT * FROM comments WHERE group_num = ? AND comment_num <> group_num ORDER BY comment_date ASC";
