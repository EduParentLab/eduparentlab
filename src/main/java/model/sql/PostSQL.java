...
public class PostSQL {
	...
	public final static String POST = "SELECT p.post_num, p.post_subject, p.post_content, p.post_date, p.post_view, p.category_num, p.email, u.nickname, p.likes FROM Post p LEFT JOIN User u ON p.email = u.email";
