...
public class FileSQL { 
        ...
        public final static String FIND_BY_ID ="SELECT file_num, file_name, file_origin_name, file_path FROM `File` WHERE file_num=?";
        public final static String FIND_BY_SAVE_NAME ="SELECT file_num, file_name, file_origin_name, file_path FROM `File` WHERE file_name=?";
}
